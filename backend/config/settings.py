...
SECRET_KEY = os.environ.get('SECRET_KEY', 'default-unsafe-key-for-local')
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [("127.0.0.1", 6379)], # Адрес локального Redis
        },
    },
}
...
STATIC_URL = 'static/'
# Папка, куда Django соберет всю статику командой collectstatic
STATIC_ROOT = BASE_DIR / 'staticfiles' 

# Оптимизация WhiteNoise: кэширование и сжатие (Brotli/Gzip)
STORAGES = {
    "default": {
...
# --- МЕДИА (Пользовательские загрузки / Кадры с камеры) ---
MEDIA_URL = 'media/'
# Физическая папка на сервере, куда будут падать файлы
MEDIA_ROOT = BASE_DIR / 'media'

# --- Настройки CELERY ---
# Брокер сообщений (Redis)
CELERY_BROKER_URL = os.environ.get('REDIS_URL', 'redis://localhost:6379/0')
# Хранилище результатов (тоже Redis)
